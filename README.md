...
params: {
  targetChain: ChainId,
  originTokenAddress: string,    // original address without padding 0s
  amount: string,
}
```
...
```
# ---------- when should relay ---------- #
GET /shouldRelay?originTokenAddress=0x337610d27c682e347c9cd60bd4b3b107c9d34ddd&amount=10000000000000000000&targetChain=11
=> {"shouldRelay":true,"msg":""}

# ---------- when should not relay ---------- #
GET /shouldRelay?originTokenAddress=0x337610d27c682e347c9cd60bd4b3b107c9d34ddd&amount=100000&targetChain=11
=> {"shouldRelay":false,"msg":"transfer amount too small, expect at least 10000000000000000"}

GET /shouldRelay?originTokenAddress=0x00000000000000000111111111111&amount=10000000000000000000&targetChain=11
